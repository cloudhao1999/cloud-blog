...
![xiabanlema](https://cdn.staticaly.com/gh/cloudhao1999/image-hosting@master/20221018/image.5xscug7xd3w0.webp)

插件可以读取用户的配置，实现例如`上下班时间`、`下班前几分钟提醒`等

![gif](https://github.com/cloudhao1999/xiabanlema/raw/HEAD/images/setting.gif)
